    ...
    >
      <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col gap-10">
            {reasons.map((r) => (
              <div key={r.title} className="why-item flex gap-6" style={{ opacity: 0 }}>
                ...
                <div>
                  <h3 className="text-white font-bold text-2xl uppercase tracking-wide mb-2">
                    {r.title}
                  </h3>
                  <p className="text-white/70 text-lg leading-relaxed">{r.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="why-visual relative" style={{ opacity: 0 }}>
          ...
          {/* Google rating badge */}
          <div className="absolute -bottom-6 -right-6 bg-white text-[#0a0a0a] p-4 shadow-2xl">
